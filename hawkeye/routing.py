...
def add_route(config):
    ...
    config.add_route('/controlpanel', accounts.controlpanel, '/welcome/controlpanel.mako')
    ...
    config.add_route('/collaborator', accounts.collaborator_project, '/project/collaborator.mako')
    ...
    config.add_route('/observe',accounts.observe_project,'/welcome/observe.mako')